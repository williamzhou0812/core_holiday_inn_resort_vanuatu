<div class="row date_time_panel">
    <div class="col-sm-6">
        <label class="control-label datepart-label" for="name">{{ __('voyager::generic.date') }}</label>
    ...
    <div class="col-sm-6">
        <label class="control-label timepart-label" for="name">{{ __('voyager::generic.time') }}</label>
        <div class="input-group">
